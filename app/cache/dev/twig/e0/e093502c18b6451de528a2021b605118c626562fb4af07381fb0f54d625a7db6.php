...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "DebugBundle:Profiler:dump.html.twig", "/home/saelm/Documents/projects/Quiz1/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views/Profiler/dump.html.twig");
    }
}
